...
const ItemDetails = (token) => {
    ...
    // const tokenName = token.token?.token.collection.name + " " + token.token?.token.name;
            ...
            <div className={`${styles.details_container} container`}>
                <Sticky enabled={isSticky} top={60} bottomBoundary="#item_main">
                    <div className="media square border-10">
                        <LazyImage src={token.token?.token.image} alt={tokenName} />
                    </div>
                </Sticky>
                <div className={styles.main} id="item_main">
                    <div className={styles.main_about}>
                        <div className="d-flex flex-column g-10">
                            ...
                            <h2 className={styles.title}>{tokenName}</h2>
                            <div className={styles.bid}>
                                <div className="d-flex g-10">
                                    구매가 <span className="text-accent text-bold">{token.token?.market.floorAsk.price.amount.decimal} ETH</span>
                                </div>
                                {/* <div className="d-flex g-10">
                                    최고 입찰가 <span className="text-accent text-bold">2 ETH</span>
                                </div> */}
                            </div>
                        </div>
